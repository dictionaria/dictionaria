...
""")
    ...
    def test_EntryMultipleSenses(self):
        e = Entry.from_string(r"""
\lx a
\ps conj
\sn 1
...
""")
    ...
    def test_EntryWithSubentry(self):
        e = Entry.from_string(r"""
\lx aa
\ps n
\sd plants
...
""")
    ...
    def test_EntryWithExample(self):
        e = Entry.from_string(r"""
\lx bweang
\ps n
\sn 1
...
\dt 14/Jul/2010""")
        ...
        m1, m2 = word.meanings
        assert m1.xref
        self.assertEqual(m1.sd, ['plants'])
        assert not m2.xref
        assert m2.sd == ['kastom']

    def test_EntryWithMultipleSensesAsSubentries(self):
        e = Entry.from_string(r"""
\lx abdal
\lxc абдал
\lc
...
""")
    ...
    def test_EntryWithMultipleSensesAndSubentry(self):
        e = Entry.from_string(r"""
\lx yaangme
\ps v.intr
\sn 1
...
""")
        words = list(e.get_words())
        assert len(words) == 2
        self.assertEqual(words[0].ps, 'v.intr')
        self.assertEqual(words[1].ps, 'v.tr.gen')
